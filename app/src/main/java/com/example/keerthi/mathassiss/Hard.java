...
public class Hard extends Activity {
    ...
    final int[] solutionArray = new int[12];
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer count=new CountDownTimer(180000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(Hard.this,"Oops!!Time up!!",Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Hard.this, ResultActivity.class);
                Bundle b = new Bundle();
